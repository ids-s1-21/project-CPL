...
# We are going to add variable(sports) and analyse questions by sports
...
# The number of athletes per age

```{r number_of_athletes_per_age, echo = FALSE}
